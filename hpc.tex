...
To evaluate the performance of the parallelized code we performed a strong and a weak scaling. More precisely, for the strong scaling we ran the code ten times, each time varying the number of cores from 1 to 36 and from that calculated the mean time per core. The results for the respective runtimes 
...
\end{equation}
This indicates that roughly $83.4\%$ of the code is paralel.
