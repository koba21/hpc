...
For a process to be able to calculate a given pixel of its grid, it needs information of its four neighbouring pixels. Thus, to calculate the values of the lower and upper most pixels within its grid part, they need access to the calculated values from the processes above and below. For this purpose, the so called \textit{ghost cells} were introduced. These are one-dimensional rows of pixels that only exist for calculation purposes, but are not present in the actual simulation.
	...
	\begin{minipage}{0.28\linewidth}
		...
		\begin{tikzpicture}[>=triangle 60]
			...
			\draw [decorate,decoration={brace,amplitude=10pt,mirror,raise=4pt},very thick,yshift=0pt]
...
\begin{figure}[h!]
		...
		\begin{tikzpicture}[>=triangle 60]
			...
			\draw [decorate,decoration={brace,amplitude=10pt,mirror,raise=4pt},very thick,yshift=0pt]
(5.5,-2) -- (5.5,0) node [black,xshift=0.8cm] {};
			\draw [blue,decorate,decoration={brace,amplitude=10pt,mirror,raise=4pt},very thick,yshift=0pt]
(5.5,-4) -- (5.5,-2) node [black,xshift=0.8cm] {};
			\draw [decorate,decoration={brace,amplitude=10pt,mirror,raise=4pt}, very thick,yshift=0pt]
(5.5,-8) -- (5.5,-6) node [black,xshift=0.8cm] {};
			\draw [blue,decorate,decoration={brace,amplitude=10pt,mirror,raise=4pt},very thick,yshift=0pt]
(5.5,-10) -- (5.5,-8) node [black,xshift=0.8cm] {};
			\draw (6, -1) -- (7, -1) -- (7, -7);
			\draw[blue] (6, -9) -- (8, -9) -- (8, -3);
    		\draw [arrow] (7, -7) -- (6, -7);
    		\draw [blue,arrow] (8, -3) -- (6, -3);
		
		\node[blue] (snd) at (6.7,-9.5) {\large send};
...
(5.5,-8) -- (5.5,-6) node [black,xshift=0.8cm] {};
			\draw [decorate,decoration={brace,amplitude=10pt,mirror,raise=4pt},very thick,yshift=0pt]
(5.5,-10) -- (5.5,-8) node [black,xshift=0.8cm] {};
			\draw[blue] (6, -1) -- (7, -1) -- (7, -7);
			\draw (6, -9) -- (8, -9) -- (8, -3);
    		\draw [blue,arrow] (7, -7) -- (6, -7);
    		\draw [arrow] (8, -3) -- (6, -3);
		
		\node[blue] (rcv) at (6.7,-7.5) {\large receive};
...
As illustrated in Figure \ref{fig:tikz}, the thick lines are joined together in the actual simulation output. This behaviour can be achieved by letting the different processes communicate to each other in the following way:\\
First the odd-numbered processes send their values to the above and below processes, while the even-numbered ones receive from below and above, respectively. Then, this procedure is repeated with the even-numbered ones sending and the odd-numbered ones receiving. Special attention has to be paid to the lower most and the upper most process, because they do only have to send and receive from one border. The main reason to implement the comunication in this way, was to avoid a deadlock.\\
...
\node (T) at (-1,0.05) {Time}; 
\node (P) at (0,-0.5) {Threads}; 
\end{tikzpicture}
...
Our choice in implementing MPI relied on communications which were $\textit{blocking}$, meaning that execution of the code is halted until they receive ($\texttt{MPI\_RECV()}$) or are able to send ($\texttt{MPI\_SEND()}$). If one were to a use non-blocking approach, the running time may be even reduced further, which could increase the parallelized fraction of the code, $\alpha$.\\
