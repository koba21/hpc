...
Apart from usual MPI formalisms, such as calling \texttt{MPI\_INIT}, \texttt{MPI\_FINALIZE} and other syntactically necessary methods, the main components that needed to be adjusted were 
